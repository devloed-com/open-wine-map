...
def translate_one(provider, job: dict) -> tuple[list[str] | None, str | None]:
    ...
    system = SYSTEM_PROMPTS[src_lang].format(lang_name=LOCALE_NAME[job["lang"]])
